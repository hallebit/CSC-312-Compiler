...
./compiler ../tests/testIfBooleanFalse                      >>   ../tests/OutputResult
./compiler ../tests/testIfBooleanOutput                     >>   ../tests/OutputResult
./compiler ../tests/testIfBooleanTrue                       >>   ../tests/OutputResult
./compiler ../tests/testIfLeqFalse                          >>   ../tests/OutputResult
./compiler ../tests/testIfLeqTrue                           >>   ../tests/OutputResult
# Fatal error: exception Failure("Unexpected Value Provided: Not a VBool")
./compiler ../tests/testIfNumericCondition                  &>>  ../tests/OutputResult
